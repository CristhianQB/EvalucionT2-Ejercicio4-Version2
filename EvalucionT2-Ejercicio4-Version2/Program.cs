...
namespace EvalucionT2_Ejercicio4_Version2
{
    internal class Program
    {
        public static void Main()
        {
            ...
            int NumeroTandom2 = NumeroRandom1.Next(1,1000);
            
            int[] A = new int[NumeroTandom2];
            int[] B = new int[NumeroTandom2];
            int contadorB = 0;

            Random NumeroRandom = new Random();

            for (int i = 0; i < NumeroTandom2; i++)
            {
